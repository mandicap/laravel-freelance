<nav x-data="{ open: false }" class="bg-blue-500 border-b border-blue-400">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 text-blue-200 hover:text-blue-700 focus:outline-none focus:text-blue-700 transition">
        ...
        <div class="pt-4 pb-1 border-t border-blue-300">
            <div class="flex items-center px-4">
                ...
                <div class="font-medium text-xs">
                    <div class="text-blue-800">{{ Auth::user()->name }}</div>
                    <div class="text-blue-300">{{ Auth::user()->email }}</div>
                </div>
            </div>
            ...
            <div class="mt-3 space-y-1">
                ...
                @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                    ...
                    <div class="block px-4 py-2 text-xs text-blue-800">
                        {{ __('Manage Team') }}
                    </div>
